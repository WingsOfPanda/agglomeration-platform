# lib/ — shared part utilities

These are Maestro-shipped helpers for rehearsal part experiments.
Import via:
...
DO NOT reach into peer experiment dirs (`../../<other-instrument>/experiments/.../code/`)
by absolute path. If you find yourself doing that, the function belongs
here — open a follow-up issue and ask the Maestro to promote it into this lib.
