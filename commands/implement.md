...
`<!-- ap:implement n/4 end -->`. If what follows is not that directive (a placeholder, or nothing),
...
!`node "${CLAUDE_PLUGIN_ROOT}/dist/ap.cjs" directive implement 1 --of 4`
!`node "${CLAUDE_PLUGIN_ROOT}/dist/ap.cjs" directive implement 2 --of 4`
!`node "${CLAUDE_PLUGIN_ROOT}/dist/ap.cjs" directive implement 3 --of 4`
!`node "${CLAUDE_PLUGIN_ROOT}/dist/ap.cjs" directive implement 4 --of 4`
