// tests/implement-find-latest-doc.test.ts — T6: implement find-latest-doc verb (no-arg source defaulting).
...
describe("implement find-latest-doc", () => {
  ...
  it("prints the newest *-design.md under */_design/design-doc by mtime", async () => {
    const sd = repoStateDir();
    const a = join(sd, "topic-a", "_design", "design-doc"); mkdirSync(a, { recursive: true });
    const b = join(sd, "topic-b", "_design", "design-doc"); mkdirSync(b, { recursive: true });
