// tests/autoresearch-core.test.ts — pure logic for /ap:autoresearch (Phase A).
import { describe, it, expect } from "vitest";
import { readFileSync } from "node:fs";
import { join } from "node:path";
import {
  autoresearchArtDir, workersDir, workerStateDir, experimentsDir, experimentDir,
} from "../src/core/autoresearch.js";
import { extractMetric, METRIC_VOCAB } from "../src/core/autoresearchMetric.js";
import { formatMetricBlock, parseMetricMd } from "../src/core/autoresearchMetric.js";
import { formatSotaBlock } from "../src/core/autoresearchMetric.js";
import { validateResult, type ResultJson } from "../src/core/autoresearchResult.js";
import { renderScoreboardRow, buildScoreboard, type ScoreRow } from "../src/core/autoresearchResult.js";
import { normalizeResult } from "../src/core/autoresearchResult.js";
import { buildStatusBrief } from "../src/core/autoresearchBrief.js";
import type { CompletionSignals } from "../src/core/autoresearchComplete.js";

describe("autoresearch art-dir paths", () => {
  it("layers _autoresearch/workers/<agent>/experiments/<exp-id>", () => {
    const art = autoresearchArtDir("add-oauth");
    expect(art.endsWith("/_autoresearch")).toBe(true);
...
import { checkCompletion } from "../src/core/autoresearchComplete.js";
...
import { buildConsensus } from "../src/core/autoresearchConsensus.js";
import {
...
} from "../src/core/autoresearchExperiment.js";
...
describe("autoresearchExperiment", () => {
...
describe("autoresearch experiment template", () => {
  const tpl = readFileSync(join(__dirname, "..", "config", "prompt-templates", "autoresearch", "experiment.md"), "utf8");
...
describe("autoresearchBrief", () => {
  const SIG: CompletionSignals = { floorMet: true, targetMet: false, kSoFar: 1, kRequired: 2, plateau: false };
  const worker = (over: Partial<import("../src/core/autoresearchBrief.js").WorkerBrief> = {}) => ({
...
import { parseMetricMd as parseMetricMdB1, formatMetricBlock as formatMetricBlockB1 } from "../src/core/autoresearchMetric.js";
