#!/usr/bin/env bash
# Phase C ACCEPTANCE GATE + Phase D wind-down — simulated-workers dogfood for /ap:rehearsal.
#
...
# Scaffold one simulated worker: its _rehearsal state (state.txt + experiments dir)
